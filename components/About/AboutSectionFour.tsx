              ...
              >
                <div className="w-full items-center">
                  ...
                  >
                    ...
                    <p className="text-3xl lg:text-7xl lg:font-bold bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 inline-block text-transparent bg-clip-text leading-10">
                      {t("Title2")}
                    </p>
                  </animated.div>
